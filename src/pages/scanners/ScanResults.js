                        ...
                        >
                            ...
                            {viewMode === 'grid' && (
                                <p className="vuln-description">
                                    {sanitize(vuln.description?.substring(0, 120))}...
                                </p>
                            )}
                            ...
                            <div className="vuln-card-footer">
                                <span className="vuln-url">{sanitize(vuln.url)}</span>
                ...
                footer={
                    selectedVuln && (
                        <div className="modal-footer-content">
                            ...
                            <a
                                href={validateUrl(selectedVuln.url)}
                                target="_blank"
                    ...
                    <div className="vuln-detail">
                        ...
                        <div className="detail-section">
                            ...
                            <div className="url-box">
                                <span className="url-text">{sanitize(selectedVuln.url)}</span>
                                <a
                                    href={validateUrl(selectedVuln.url)}
                                    target="_blank"
                                    rel="noopener noreferrer"
                        ...
                        <div className="detail-section">
                            ...
                            <p className="section-text">
                                {sanitize(selectedVuln.description) || 'No description available for this vulnerability.'}
                            </p>
                        </div>
                        ...
                        {selectedVuln.evidence && (
                            <div className="detail-section">
                                ...
                                <pre className="code-block">{sanitize(selectedVuln.evidence)}</pre>
                            </div>
                        )}
                        ...
                        {selectedVuln.remediation && (
                            <div className="detail-section">
                                ...
                                <p className="section-text">{sanitize(selectedVuln.remediation)}</p>
                            </div>
                        )}
                    </div>
                )}
